            ...
            <div class="container">
                <div class="sidebar">
                    <ul>
                      ...
                      <li class="admin" id=""><a href="javascript:showSaoKet7();"><i class="fa-solid fa-hammer"></i>Sao Kê Đại Lý Tháng 7</a></li>
                        <li class="admin" id=""><a href="javascript:showSaoKe();"><i class="fa-solid fa-hammer"></i>Sao Kê Đại Lý Tháng 8</a></li>
                      	<li class="admin" id=""><a href="javascript:showChinhSach();"><i class="fa-solid fa-hammer"></i>Chính sách đại lý</a></li>
                    </ul>
                </div>
                <div class="content ">
