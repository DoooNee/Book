...
function findDaiLy($input) {
    ...
    if (strpos($input, 'DLNK') !== false) {
  	...
  	if (strpos($input, 'DLTT') !== false) {
        return 'TangTap';
    }
    if (strpos($input, 'DLKB') !== false) {
          return 'KunBanThe';
      }
...
$sql = "INSERT INTO webhook (daily, sotien, description, username,status, thoigiannap) VALUES ('$daily' ,'$sotien', '$mota', '$username', '' , '$thoigiannap')";
